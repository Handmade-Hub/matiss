document.addEventListener('DOMContentLoaded', function () {
  ...
  // modal add to cart
  if (document.querySelectorAll('.modal-order').length) {
    const modal = document.querySelector('.modal-order');
    const addFile = document.querySelector('.modal-order__add-file_button');

    Array.prototype.forEach.call(addFile, function (input) {
